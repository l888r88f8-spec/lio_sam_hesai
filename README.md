...
Adapted LIO-SAM for Hesai XT16. This fork renames the package to `lio_sam_hesai` (ROS package names must be lowercase) and updates configs/launch for hesai usage.
...
- Set sensor to Hesai settings (rings, horizon) appropriate for Hesai XT16
