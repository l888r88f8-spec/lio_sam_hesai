...
pcl::PointCloud<relocalization::PointXYZIRT>::Ptr PreProcessing::ConvertMessageToCloud(
  ...
  if (LidarModel::Instance()->lidar_sensor_type_ ==
    ...
    pcl::PointCloud<relocalization::VelodynePointXYZIRT> cloud_velodyne;
    ...
    pcl::PointCloud<relocalization::OusterPointXYZIRT> cloud_ouster;
    ...
    pcl::PointCloud<relocalization::LsPointXYZIRT> cloud_ls;
    ...
    pcl::PointCloud<relocalization::RsPointXYZIRT> cloud_rs;
    ...
    pcl::PointCloud<relocalization::LivoxPointXYZITLT> cloud_livox;
...
void PreProcessing::ComputePointOffsetTime(
    const pcl::PointCloud<relocalization::PointXYZIRT>::Ptr& cloud, const double lidar_rate) {
...
std::pair<float, float> PreProcessing::GetLidarPointMinMaxOffsetTime(
    const pcl::PointCloud<relocalization::PointXYZIRT>::Ptr& cloud) {
